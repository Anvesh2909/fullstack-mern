...
const Footer = () => {
    ...
    return (
        <footer className="mt-40 px-4 md:px-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-[2fr_1fr_1fr] gap-12 py-12">
                    <div className="space-y-6">
                        ...
                        <p className="text-gray-600 leading-relaxed max-w-md">
                            ...
                            you to care, anytime, anywhere.
                        </p>
                        <div className="flex space-x-4 pt-4">
                            <a href="#" className="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-primary hover:bg-blue-100 transition-colors">
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-center space-x-3 text-gray-600 ">
                                <Phone className="w-5 h-5 text-primary hover:scale-[1.1] transition-all duration-300" />
                                <span>+916305625811</span>
                            </li>
                            <li className="flex items-center space-x-3 text-gray-600">
                                <Mail className="w-5 h-5 text-primary hover:scale-[1.1] transition-all duration-300" />
                                <a
                                    href="mailto:anveshyadavmokam@gmail.com"
                                    className="hover:text-primary transition-colors"
                                >
                                    anveshyadavmokam@gmail.com
                                </a>
                            </li>
                        </ul>
                    </div>
